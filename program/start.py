...
🎗 [{BOT_NAME}](https://t.me/{BOT_USERNAME}) **انا بوت يمديني اشغل اغاني في المكالمه المرئيه! 🥇︙**
...
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "🌐 كروب الدعم 🌐", url=f"https://t.me/ELGMD"
                    ),
                    InlineKeyboardButton(
                        "🌐 قناة البوت 🌐", url=f"https://t.me/Gaamd_23"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "⃟𝑺𝑶𝑼𝑹𝑪𝑬𝑩𝑶𝑫𝑨", url="https://t.me/Gaamd_23"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("اوامر التشغيل", url=f"https://t.me/Gaamd_23"),
                InlineKeyboardButton(
                    "مطور السورس", url=f"https://t.me/Gaaaamd"
                ),
            ]
        ]
    )
...
async def src(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        ...
        alive = f"**هلا {message.from_user.mention()}, i m {BOT_NAME}**\n\nℹ️ 🎶 هذا هو ميوزك بودآ المجاني\nℹ️  اختصاص هذا البوت لتشغيل مقاطع صوتية او مقاطع الفيديو في المكالمات الصوتية \n\n**⚒ ل عرض اوامر البوت يمكنك مشاهده الفيديو او قم بدخول الى خاص البوت وتابع التعليمات** 💖"

    await message.reply_photo(
        photo=f"https://telegra.ph/file/09444ef9539147568e222.jpg",
        caption=alive,
        reply_markup=keyboard,
    )
